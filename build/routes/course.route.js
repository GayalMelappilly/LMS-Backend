...
courseRouter.get('/get-courses/:id', course_controller_1.getAllCourses);
...
courseRouter.get('/get-courses', user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)('admin'), course_controller_1.getAllCourses);
